class user_interface:
    ...
    def operations(self):
        ...
        print("\033[36me. Power or exponent\033[0m".center(85))
        print("\033[36mf. Modulo\033[0m".center(85))
        math = input("\n\033[33;3mPlease choose a math operation you want to use (a/b/c/d/e/f): \033[0m")
        return math
